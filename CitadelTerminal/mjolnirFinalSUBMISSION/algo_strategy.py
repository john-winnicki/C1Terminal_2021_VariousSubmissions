...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def hard_scoutStrat_clearLeft(self, game_state):
        ...
        if game_state.project_future_MP() >= 8:
            ...
            game_state.attempt_spawn(WALL, [[17, 7]])
        else:
            self.build_defences(game_state)
    ...
    def hard_scoutStrat_left(self, game_state):
        if game_state.get_resource(MP, 0) >= 20:
            ...
            game_state.attempt_spawn(SCOUT, [13, 0], 8)
            game_state.attempt_spawn(SCOUT, [10, 3], math.floor(3 * mp / 4))
    ...
    def hard_scoutStrat_right(self, game_state):
        if game_state.get_resource(MP, 0) >= 20:
            ...
            mp = game_state.get_resource(MP, 0)
            game_state.attempt_spawn(SCOUT, [17, 3], 8)
            game_state.attempt_spawn(SCOUT, [14, 0], math.floor(3 * mp / 4))
    ...
    def build_defences(self, game_state):
        game_state.attempt_remove([[17, 7]])
        turret_locations_1 = [[11, 9], [17, 6], [2, 11], [25, 11]]
        wall_locations_1 = [[0, 13], [27, 13], [1, 12], [1, 13],
        ...
        wall_locations_2 = [[0, 13], [26, 13], [1, 12], [1, 13],
                               [2, 12], [3, 12], [4, 12], [23, 12], [24, 12], [25, 12], [26, 12], [3, 11], [4, 11],
        ...
        support_locations_3 = [[11, 5], [16, 5], [12, 4], [15, 4], [13, 3], [14, 3]]
        turret_locations_3 = [[2, 11], [25, 11], [9, 9], [11, 9], [14, 9], [9, 8], [12, 8], [13, 8], [17, 6]]
        wall_locations_3 = [[0, 13], [27, 13], [1, 12], [1, 13],
                               [2, 12], [3, 12], [4, 12], [23, 12], [24, 12], [25, 12], [26, 12], [3, 11], [4, 11],
