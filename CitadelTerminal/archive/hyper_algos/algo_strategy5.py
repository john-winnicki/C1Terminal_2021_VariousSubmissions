...
class AlgoStrategy(gamelib.AlgoCore):
	...
	def hard_scoutStrat_part1(self, game_state):
		...
		count1 = self.detect_enemy_unit(game_state, unit_type=None, valid_x=[0,3], valid_y=[14, 21])
		...
		count4 = self.detect_enemy_unit(game_state, unit_type=None, valid_x=[24,27], valid_y=[14, 21])
	...
	def hard_scoutStrat_part2(self, game_state):
		...
		mp = game_state.get_resource(MP, 0)
		if game_state.get_resource(MP, 0) >= 25:
			...
			if self.open_channel==1:
				game_state.attempt_spawn(SCOUT, [13,0], 4)
